      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-sm text-gray-600">
                Explore the latest in mobile technology with TruMobiles.
                Discover a wide selection of smartphones, tablets, and
                accessories to enhance your digital lifestyle.
              </p>
              <p className="mt-4 text-sm text-gray-600">
                Benefit from swift delivery, secure transactions, and
                unparalleled customer support. Elevate your mobile experience
                with TruMobiles today!
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href="/"
              className="transition-colors duration-300 text-white hover:text-orange-400"
            >
