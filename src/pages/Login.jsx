    ...
    <section className="min-h-screen flex items-stretch text-white ">
      ...
      >
        ...
        <div className="w-full px-24 z-10">
          <h1 className="text-5xl font-bold text-left tracking-wide text-orange-500">
            Let Your Styles <br />speak for yourself
          </h1>
      ...
      >
        ...
        <div className="w-full py-6 z-20">
          <h1 className="my-6 ">
            <img src={require('../images/eCart-Logo.png')} alt="logo" className="w-1/3 m-auto" />
          </h1>
          ...
          <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            ...
            <div className="px-4 pb-2 pt-4">
              <button className="uppercase block w-full p-4 text-lg rounded-full bg-orange-500 hover:bg-orange-600 focus:outline-none">
                sign in
              </button>
            </div>
            <p className="mt-4">Don't have an account yet?
              <a href="#" className="text-orange-500 hover:underline hover:text-orange-600 ml-2">Sign up</a>
            </p>
